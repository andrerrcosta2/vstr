...
func TestEq(t *testing.T) {
	...
	assert.True(t, id1.Eq(id2), "Eq() should return true for equal IDs")
	assert.False(t, id1.Eq(id3), "Eq() should return false for different IDs")
}
...
func TestBtw(t *testing.T) {
	...
	id1 := NewId(tk1) // 4b84b15bff6ee5796152495a230e45e3d7e947d9
	id2 := NewId(tk2) // 9c678c09e0163cb9f0bdaf0363047ac5b549704e
	id3 := NewId(tk3) // 4cb76ef2b5226800f33753538f867f39fd13c0ab
